export const ru = {
    ...
    "Todos": "Каждый",
    "Número de pedidos": "количество заказов",
    "Histórico prealerta": "История до оповещения",
    "Lista de prealertas históricas": "Список исторических предварительных предупреждений",
    "Clonar": "клон",
    "Registros no encontrados": "Записи не найдены",
    "Roles": "роли",
    "Administrador": "Администратор",
    "Compras": "Покупка",
    "Estados": "штат",
    "Templates": "шаблоны",
    "Gestión de pedido": "управление заказами",
    "Pedidos a procesar": "заказы на обработку",
    "Pendiente": "в ожидании",
    "Detalle del pedido": "детали заказа",
    "Pedido": "порядок",
    "Rechazar pedido": "отклонить запрос",
    "Pasar a revisión": "Перейти к обзору",

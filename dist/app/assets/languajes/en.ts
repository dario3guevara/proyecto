export const en = {
    ...
    "Histórico prealerta": "Pre-alert history",
    "Lista de prealertas históricas": "List of historical pre-alerts",
    "Clonar": "Clone",
    "Registros no encontrados": "No records found",
    "Roles":"Roles",
    "Administrador":"Administrator",
    "Compras":"Shopping",
    "Estados":"States",
    "Templates":"Templates",
    "Gestión de pedido":"Order management",
    "Pedidos a procesar":"Orders to process",
    "Pendiente":"Pending",
    "Detalle del pedido":"Order detail",
    "Pedido":"Order",
    "Rechazar pedido":"Reject request",
    "Pasar a revisión":"Go to review",
    "Continuar":"Continue"

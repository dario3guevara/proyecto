export const ch={
    ...
    "Reclamos":"要求",
    "Pedidos": "命令",
    "Pedidos en trámite":"处理中的订单",
    "Fase": "阶段",
    "# Pedido": "＃ 命令",
    "Nuevo pedido":"新命令",
    "Editando el pedido":"编辑订单",
    "Crear pedido":"创建订单",
    "Lista de pedidos":"订单",
    "Fecha envío":"发送日期",
    "Fecha envio es requerida":"发货日期为必填项",
    "Cantidad":"数量",
    "Cantidad es requerido":"数量为必填项",
    "Finalizar":"敲定",
    "Cancelar Pedido":"取消订单",
    "Tracking del pedido":"订单跟踪",
    "Items del pedido":"订购商品",
    "Generado":"生成",
    "Revisión":"修订",
    "Despachado":"已派遣",
    "Recibido":"已收到",
    ...
    "Cancelado":"取消",
    "Regresar":"返回",
    "Histórico de pedidos":"订单历史",
    "Transacciones":"交易",
    "Todos":"每个人",
    "Número de pedidos":"订单数量",
    "Histórico prealerta":"预警历史",
    "Lista de prealertas históricas":"历史预警列表",
    "Clonar":"克隆",
    "Registros no encontrados": "未找到记录",
    "Roles":"角色",
    "Administrador":"行政人员",
    "Compras":"购物",
    "Estados":"状态",
    "Templates":"模板",
    "Gestión de pedido":"订单管理",
    "Pedidos a procesar":"要处理的订单",
    "Pendiente":"待办的",
    "Detalle del pedido":"订单详情",
    "Pedido":"命令",
    "Rechazar pedido":"拒绝请求",
    "Pasar a revisión":"去评论",
    "Continuar":"继续"
};

...
rem # set for google kms 2021
GOOGLE_APPLICATION_CREDENTIALS=/opt/kms/kmsapiecuposprivate.json
...
set "JAVA_OPTS=-Xms256M -Xmx2048M -XX:MetaspaceSize=96M -XX:MaxMetaspaceSize=256m"
